 ...
 */
@Component
public class ExecuteFlagExecutor implements ShapeExecutor, Grammerable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ExecuteFlagExecutor.class);
    ...
    public List<Grammer> grammers() {
        ...
        grammer.setComment("顺序获取表数据");
        grammer.setFunction("rs");
        grammer.setReturns(Arrays.asList("Map<String,Object>", "int"));
