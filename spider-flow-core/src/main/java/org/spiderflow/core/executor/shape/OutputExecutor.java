...
public class OutputExecutor implements ShapeExecutor, SpiderListener {
    ...
    public static final String OUTPUT_REMOTESERVER = "output-remoteserver";
    ...
    public void execute(SpiderNode node, SpiderContext context, Map<String, Object> variables) {
        ...
        boolean remoteserverFlag = "1".equals(node.getStringJsonValue(OUTPUT_REMOTESERVER));
        ...
        if (databaseFlag || csvFlag || remoteserverFlag) {
        ...
        for (Map<String, String> item : outputs) {
            ...
            if ((databaseFlag || csvFlag || remoteserverFlag) && value != null) {
